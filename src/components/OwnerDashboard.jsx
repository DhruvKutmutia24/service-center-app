...
//       // Fetch all vehicles with assigned user info and work stages
...
//   // NEW: Get vehicles by department work status (for parallel workflow)
//   const getVehiclesByDepartment = (department) => {
...
//       switch (department) {
//         case "mechanic":
//           return ws.mechanic_required && ws.mechanic_status !== "completed";
//         case "painter":
//           return ws.painter_required && ws.painter_status !== "completed";
//         case "denter":
//           return ws.denter_required && ws.denter_status !== "completed";
//         case "electrician":
//           return (
//             ws.electrician_required && ws.electrician_status !== "completed"
//           );
//         case "three_m":
//           return ws.three_m_required && ws.three_m_status !== "completed";
//         case "alignment_balancing":
//           return (
//             ws.alignment_balancing_required &&
//             ws.alignment_balancing_status !== "completed"
//           );
//         case "tyre_fitting":
//           return (
//             ws.tyre_fitting_required && ws.tyre_fitting_status !== "completed"
//           );
//         case "washing":
//           return ws.washing_required && ws.washing_status !== "completed";
//         default:
//           return false;
//       }
//     });
...
//   // Helper function to get department-specific status
//   const getDepartmentStatus = (workStage, department) => {
//     if (!workStage) return "unknown";

//     const statusMap = {
//       mechanic: workStage.mechanic_status,
//       painter: workStage.painter_status,
//       denter: workStage.denter_status,
//       electrician: workStage.electrician_status,
//       three_m: workStage.three_m_status,
//       alignment_balancing: workStage.alignment_balancing_status,
//       tyre_fitting: workStage.tyre_fitting_status,
//       washing: workStage.washing_status,
//     };

//     return statusMap[department] || "unknown";
//   };

//   // Get active departments for a vehicle
//   const getActiveDepartments = (vehicle) => {
//     const ws = vehicle.work_stages?.[0];
//     if (!ws) return [];

//     const departments = [];

//     if (ws.mechanic_required && ws.mechanic_status !== "completed") {
//       departments.push({
//         name: "Mechanic",
//         status: ws.mechanic_status,
//         color: "#f59e0b",
//       });
//     }
//     if (ws.painter_required && ws.painter_status !== "completed") {
//       departments.push({
//         name: "Painter",
//         status: ws.painter_status,
//         color: "#a855f7",
//       });
//     }
//     if (ws.denter_required && ws.denter_status !== "completed") {
//       departments.push({
//         name: "Denter",
//         status: ws.denter_status,
//         color: "#14b8a6",
//       });
//     }
//     if (ws.electrician_required && ws.electrician_status !== "completed") {
//       departments.push({
//         name: "Electrician",
//         status: ws.electrician_status,
//         color: "#f97316",
//       });
//     }
//     if (ws.three_m_required && ws.three_m_status !== "completed") {
//       departments.push({
//         name: "3M",
//         status: ws.three_m_status,
//         color: "#6366f1",
//       });
//     }
//     if (
...
//       departments.push({
//         name: "A&B",
//         status: ws.alignment_balancing_status,
//         color: "#ec4899",
//       });
//     }
//     if (ws.tyre_fitting_required && ws.tyre_fitting_status !== "completed") {
//       departments.push({
//         name: "Tyre",
//         status: ws.tyre_fitting_status,
//         color: "#84cc16",
//       });
//     }
//     if (ws.washing_required && ws.washing_status !== "completed") {
//       departments.push({
//         name: "Wash",
//         status: ws.washing_status,
//         color: "#06b6d4",
...
//   // ✅ FIXED: Use useMemo to recalculate stats whenever vehicles array changes
//   const stats = useMemo(() => {
...
//       (v) => new Date(v.entry_time).toDateString() === today,
//     );
...
//     // ✅ Count ALL pending vehicles (case-insensitive + trim whitespace for safety)
//     const allPendingVehicles = vehicles.filter(
//       (v) => v.current_stage?.trim().toLowerCase() === "pending",
//     ).length;

//     return {
//       total: todayVehicles.length,
//       completed: completedToday.length,
//       inProgress: allPendingVehicles,
//     };
//   }, [vehicles]); // Recalculate whenever vehicles array changes
...
//             {/* Critical Alerts - 2 Column Layout for Full Width */}
//             <div
//               style={{
//                 display: "grid",
//                 gridTemplateColumns: "repeat(2, 1fr)",
...
//                   {(() => {
//                     const pendingVehicles = getVehiclesByStage("pending");
//                     return (
//                       <div
//                         style={{
//                           backgroundColor:
...
//                               }}
//                             >
//                               🔴 Pending Vehicles (Needs Urgent Attention)
//                             </h4>
//                             <p
//                               style={{
//                                 margin: "4px 0 0 0",
...
//                             >
//                               {pendingVehicles.length === 0
//                                 ? "✅ All vehicles are assigned to departments"
//                                 : `${pendingVehicles.length} vehicle(s) waiting between work stages`}
//                             </p>
//                           </div>
//                           <span
//                             style={{
...
//                                 }}
//                               >
//                                 +{pendingVehicles.length - 3} more in
//                                 Departments tab
//                               </p>
//                             )}
//                           </div>
...
//                   {/* SLA Breached Alert */}
//                   {(() => {
//                     const breachedVehicles = vehicles.filter(
//                       (v) => v.sla_breached && v.current_stage !== "completed",
//                     );
//                     return (
//                       <div
//                         style={{
//                           backgroundColor:
//                             breachedVehicles.length > 0 ? "#fef2f2" : "#f0fdf4",
//                           border: `2px solid ${
//                             breachedVehicles.length > 0 ? "#fca5a5" : "#86efac"
//                           }`,
//                           padding: "16px",
//                           borderRadius: "8px",
//                           marginBottom: "16px",
...
//                             >
//                               {breachedVehicles.length === 0
//                                 ? "✅ All vehicles on track"
//                                 : `${breachedVehicles.length} vehicle(s) exceeded expected time`}
//                             </p>
//                           </div>
//                           <span
//                             style={{
...
//                             }}
//                           >
//                             {breachedVehicles.slice(0, 3).map((v) => (
//                               <div
//                                 key={v.id}
//                                 onClick={() => setSelectedVehicle(v)}
//                                 style={{
...
//                                   style={{ fontSize: "12px", color: "#6b7280" }}
//                                 >
//                                   Stage: {v.current_stage.replace("_", " ")}
//                                 </span>
//                               </div>
//                             ))}
//                             {breachedVehicles.length > 3 && (
//                               <p
//                                 style={{
//                                   margin: "8px 0 0 0",
//                                   fontSize: "12px",
...
//                                 }}
//                               >
//                                 +{breachedVehicles.length - 3} more vehicles
//                                 delayed
//                               </p>
//                             )}
//                           </div>
...
//                             >
//                               {priorityVehicles.length === 0
//                                 ? "✅ No priority vehicles in progress"
//                                 : `${priorityVehicles.length} high priority vehicle(s) in service`}
//                             </p>
//                           </div>
//                           <span
//                             style={{
...
//                             }}
//                           >
//                             {priorityVehicles.slice(0, 3).map((v) => (
//                               <div
//                                 key={v.id}
//                                 onClick={() => setSelectedVehicle(v)}
//                                 style={{
...
//                                   style={{ fontSize: "12px", color: "#6b7280" }}
//                                 >
//                                   {v.current_stage.replace("_", " ")}
//                                 </span>
//                               </div>
//                             ))}
//                             {priorityVehicles.length > 3 && (
//                               <p
//                                 style={{
//                                   margin: "8px 0 0 0",
//                                   fontSize: "12px",
...
//                                 }}
//                               >
//                                 +{priorityVehicles.length - 3} more priority
//                                 vehicles
//                               </p>
//                             )}
//                           </div>
...
//                   {/* Exceeding Expected Time Alert */}
//                   {(() => {
//                     const now = new Date();
//                     const delayedVehicles = vehicles.filter((v) => {
//                       if (v.current_stage === "completed") return false;

//                       // Only check if advisor has set expected completion time
...
//                       return false; // No expected time set = no alert
//                     });
//                     return (
//                       <div
//                         style={{
//                           backgroundColor:
//                             delayedVehicles.length > 0 ? "#fef3c7" : "#f0fdf4",
//                           border: `2px solid ${
//                             delayedVehicles.length > 0 ? "#fbbf24" : "#86efac"
//                           }`,
//                           padding: "16px",
//                           borderRadius: "8px",
//                         }}
...
//                             >
//                               {delayedVehicles.length === 0
//                                 ? "✅ All vehicles within expected timeframe"
//                                 : `${delayedVehicles.length} vehicle(s) past expected completion time`}
//                             </p>
//                           </div>
//                           <span
//                             style={{
...
//                             }}
//                           >
//                             {delayedVehicles.slice(0, 3).map((v) => {
//                               const expectedTime = new Date(
//                                 v.expected_completion_time,
//                               );
//                               const hoursOverdue = Math.floor(
//                                 (now - expectedTime) / (1000 * 60 * 60),
//                               );
...
//                                 }}
//                               >
//                                 +{delayedVehicles.length - 3} more vehicles
//                               </p>
//                             )}
//                           </div>
//                         )}
...
//                           type: "department",
//                         },
//                         { stage: "pdi", label: "PDI", color: "#3b82f6" },
//                         {
//                           stage: "billing",
//                           label: "Billing",
//                           color: "#6366f1",
//                         },
//                       ].map(({ stage, label, color, type }) => {
//                         const count =
//                           type === "department"
//                             ? getVehiclesByDepartment(stage).length
//                             : getVehiclesByStage(stage).length;
...
//               }}
//             >
//               All Departments - Live Vehicle Tracking
//             </h3>
//             <div
//               style={{
//                 display: "grid",
...
//             >
//               {[
//                 // Non-work stages (use current_stage)
//                 {
//                   stage: "pending",
//                   label: "⏳ Pending",
//                   color: "#ef4444",
...
//                 // Work departments (use work_stages) - PARALLEL WORKFLOW
//                 {
//                   stage: "mechanic",
//                   label: "🔧 Mechanic",
//                   color: "#f59e0b",
...
//                 // Final stages (use current_stage)
//                 {
//                   stage: "pdi",
//                   label: "✅ PDI",
//                   color: "#f43f5e",
...
//                 const stageVehicles =
//                   type === "department"
//                     ? getVehiclesByDepartment(stage)
//                     : getVehiclesByStage(stage);
...
//                                   >
//                                     {type === "department"
//                                       ? getDepartmentStatus(workStages, stage)
//                                       : v.current_status}
//                                   </span>
//                                   {v.locked_by_user && (
//                                     <>
...
//                       const activeDepts = getActiveDepartments(vehicle);
//                       const inProgressDept = activeDepts.find(
...
//                             <span
//                               style={{
//                                 backgroundColor: inProgressDept
//                                   ? inProgressDept.color + "30"
//                                   : "#dbeafe",
//                                 color: inProgressDept
//                                   ? inProgressDept.color
//                                   : "#1e40af",
//                                 padding: "4px 8px",
//                                 borderRadius: "6px",
//                                 fontSize: "12px",
...
//                             }}
//                           >
//                             {vehicle.locked_by_user?.full_name ||
//                               (vehicle.is_locked ? "Unknown" : "-")}
//                           </td>
//                           <td
//                             style={{
//                               padding: "12px",
...
//                     style={{
//                       padding: "16px",
//                       backgroundColor: u.is_active ? "white" : "#f9fafb",
//                       border: "1px solid #e5e7eb",
//                       borderRadius: "8px",
//                       display: "flex",
//                       justifyContent: "space-between",
...
//           {/* Group teams by role */}
//           {(() => {
//             const roles = [...new Set(teams.map((t) => t.role))].sort();
//             const roleLabels = {
//               mechanic: "🔧 Mechanic Teams",
//               denter: "🔨 Denter Teams",
//               electrician: "⚡ Electrician Teams",
//               painter: "🎨 Painter Teams",
//               three_m: "✨ 3M Teams",
//               tyre_fitting: "🛞 Tyre Fitting Teams",
//               washing: "💧 Washing Teams",
//             };
...
//             ) : (
//               roles.map((role) => {
//                 const roleTeams = teams.filter((t) => t.role === role);
//                 return (
...
//                     >
//                       {roleLabels[role] ||
//                         role.replace(/_/g, " ").toUpperCase() + " Teams"}
//                     </h4>
//                     <div
//                       style={{
//                         display: "grid",
...
//   );
// }
// function AddTeamForm({ onClose, onSuccess }) {
...
//     { value: "three_m", label: "✨ 3M" },
//     { value: "tyre_fitting", label: "🛞 Tyre Fitting" },
...
//       >
//         <h3
//           style={{ margin: "0 0 20px 0", fontSize: "20px", color: "#111827" }}
//         >
//           Create New Team
//         </h3>
...
//   );
// }
// function EditTeamForm({ team, users, onClose, onSuccess }) {
//   const [teamName, setTeamName] = useState(team.name);
//   const [error, setError] = useState("");
//   const [loading, setLoading] = useState(false);

//   // Get members of this team and available users of same role
...
//       alert("Please remove all members from this team before deleting it.");
//       return;
//     }
...
//               }}
//             >
//               No available {team.role.replace(/_/g, " ")} users to add
//             </p>
//           ) : (
//             <div style={{ display: "grid", gap: "8px" }}>
...
//                       }}
//                     >
//                       {u.team_id ? "(In another team)" : "Unassigned"}
//                     </span>
//                   </div>
//                   <button
...
//       alert(`${formData.full_name} added successfully!`);
//       onSuccess();
//     } catch (err) {
...
//       if (fnError) throw new Error(fnError.message || "Failed to update user");
//       if (data?.error) throw new Error(data.error);
...
//             }}
//           >
//             ✅ Linked to Supabase Auth — phone & password changes will sync to
//             login credentials
//           </div>
//         )}
...
//             }}
//           >
//             ⚠️ No Supabase Auth linked — password change will only update local
//             record
//           </div>
//         )}
...
//                   (login email will change to {formData.phone}@sheetal.auto)
//                 </span>
//               )}
//             </label>
//             <input
